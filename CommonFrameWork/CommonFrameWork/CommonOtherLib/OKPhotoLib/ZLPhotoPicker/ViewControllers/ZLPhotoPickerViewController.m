...
//可继承自己项目的自定义导航 modify by maowangxin
@interface CCCustomNavigationController : UINavigationController
@end

@implementation CCCustomNavigationController
@end
...
- (void) createNavigationController{
    ...
    CCCustomNavigationController *nav = [[CCCustomNavigationController alloc] initWithRootViewController:groupVc];
...
- (void)viewWillDisappear:(BOOL)animated{
    ...
    //可用自己项目共用转圈类 modify by maowangxin
